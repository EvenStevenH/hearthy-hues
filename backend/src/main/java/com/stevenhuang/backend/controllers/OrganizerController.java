...
public class OrganizerController {
    ...
    // GET all > http://localhost:8080/api/organizers
    @GetMapping
    public List<Organizer> getAllOrganizers() {
        return organizerRepository.findAll();
    }

    // GET one > http://localhost:8080/api/organizers/{id}
    @GetMapping("/{id}")
    ...
    // PUT > http://localhost:8080/api/organizers/{id}
    @PutMapping("/{id}")
    ...
    // DELETE > http://localhost:8080/api/organizers/{id}
    @DeleteMapping("/{id}")
